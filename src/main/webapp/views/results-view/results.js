 ...
 */
resultsView.controller('ResultsViewCtrl', ['$scope', '$location', '$document', '$anchorScroll', 'Results', 'ngProgress',
    function ($scope, $location, $document, $anchorScroll, results, ngProgress) {
