...
(function($) {
	...
	function initContainer(container) {
		...
		// options table
		parentTable += '<tr> ';
		parentTable += '<td rowspan="'+rowspan+'" valign="top" id="'+getElementId(container, elementIds.optionsTable)+'" class="lorikeet-option-table"> ';
		parentTable += '</td> ';

        if(options.showSequenceInfo) {
            // placeholder for sequence, m/z, scan number etc
            parentTable += '<td style="background-color: white; padding:5px; border:1px solid #f1f1f1;" valign="bottom" align="center"> ';
		...
		parentTable += '<tr> ';
		parentTable += '<td style="background-color: white; padding:5px; border:1px solid #f1f1f1;" valign="top" align="center"> ';
	...
	function showSequenceInfo (container) {
		...
		if(options.sequence) {
			...
			specinfo += '<div>';
			specinfo += '<span style="font-weight:bold; color:#207a7a;">'+getModifiedSequence(options)+'</span>';
